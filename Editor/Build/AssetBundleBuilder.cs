...
namespace Depra.Assets.Editor.Build
{
    ...
    public static class AssetBundleBuilder
    {
        ...
        /// </summary>
        private const string ROOT_BUILD_PATH = "AssetBundles";
        ...
        /// </remarks>
        private const string EMBEDDED_BUNDLE_PATH = "Assets/StreamingAssets/EmbeddedAssetBundles";
        ...
        /// <remarks>
        /// <para>
        /// The resulting bundles will be output to a directory under <see cref="ROOT_BUILD_PATH"/>
        ...
        public static AssetBundleManifest BuildAssetBundles(
            BuildTarget? buildTarget = null, BuildAssetBundleOptions options = BuildAssetBundleOptions.None)
        {
        ...
        public static Dictionary<BuildTarget, AssetBundleManifest> BuildAssetBundles(
            BuildTarget[] buildTargets, BuildAssetBundleOptions options = BuildAssetBundleOptions.None)
        {
        ...
        ///
        /// <remarks>
        /// <see cref="EMBEDDED_BUNDLE_PATH"/> is reset each time this function is called.
        ...
        /// </remarks>
        public static void CopyEmbeddedBundles(string[] embeddedBundles, BuildTarget? buildTarget = null)
        {
            var target = buildTarget ?? EditorUserBuildSettings.activeBuildTarget;
            target = NormalizeBuildTarget(target);
            ...
            ResetDirectory(EMBEDDED_BUNDLE_PATH);
            ...
            foreach (var bundleName in embeddedBundles)
            {
                ...
                var destPath = Path.Combine(EMBEDDED_BUNDLE_PATH, bundleName);
        ...
        public static void PrepareBundlesForUpload(string baseUri)
        {
            ...
            bool WaitForCoroutines(IEnumerable<IEnumerator> routines)
            {
                return routines.Aggregate(false, (current, routine) => current | routine.MoveNext());
            }
        }
        ...
        /// directly.
        /// </remarks>
        public static AssetBundleDescription[] MergePlatformManifests(Dictionary<RuntimePlatform, string> paths)
        {
            var manifests = paths
        ...
        {
            var descriptions =
                new Dictionary<string, (Dictionary<RuntimePlatform, Hash128> hashes, HashSet<string> dependencies)>();
            foreach (var (platform, manifest) in manifests)
            {
            ...
            switch (target)
            {
                ...
                default:
                    throw new ArgumentException(
                        $"Cannot determine asset bundle target for unsupported build target {target}");
            }
        }

        /// <summary>
        /// Normalizes the target and appends it to <see cref="ROOT_BUILD_PATH"/>.
        /// </summary>
        private static string GetBuildPathForBuildTarget(BuildTarget target)
        {
            ...
            return Path.Combine(ROOT_BUILD_PATH, platform.ToString());
        }
        ...
        /// </summary>
        /// <param name="buildTarget">The build target to use. Assumed to already be normalized.</param>
        /// <param name="manifest">
        /// The asset bundle manifest resulting from building asset bundles for the specified target.
        /// </param>
        private static void CopyBundlesToStagingArea(BuildTarget buildTarget, AssetBundleManifest manifest)
        {
