...
namespace Depra.Assets.Runtime.Bundle
{
    /// <summary>
    ...
    /// </remarks>
    public readonly struct AssetBundleDescription : IEquatable<AssetBundleDescription>
    {
        private readonly HashSet<string> _dependencies;
        private readonly Dictionary<RuntimePlatform, Hash128> _hashes;
